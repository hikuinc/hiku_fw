...
class FactoryTester {
	...
	imp.sleep(0.02);	
	local scan_string = AUDIO_UART.readstring();
	
	//HACK HACK HACK
    scan_string = TEST_REFERENCE_BARCODES[0];
