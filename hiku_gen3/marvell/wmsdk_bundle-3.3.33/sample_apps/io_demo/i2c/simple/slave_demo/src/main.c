 ...
 * In this application MC200/MW300 is configured in slave mode.
 ...
 *| Pin No(mc200_8801) | Use |
 *---------------------------
 *|   IO_08         | SDA     |
 *|   IO_09         | SCL     |
 * --------------------------
 * Connect IO_08 and IO_09 pin of transmitter to IO_08 and IO_09 pin
 * of receiver.
 *| Pin No(mw300) | Use     |
 *---------------------------
 *|   I17         | SCL     |
 *|   I18         | SDA     |
 * --------------------------
 * Connect IO_17 and IO_18 pin of transmitter to IO_17 and IO_18 pin
 * of receiver.
 */
