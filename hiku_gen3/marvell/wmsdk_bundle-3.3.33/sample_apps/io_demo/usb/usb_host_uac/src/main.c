...
void event_wlan_init_done(void *data)
{
	...
	audio_buffer = os_mem_alloc(AUD_BUF_LEN);
	if (audio_buffer == NULL) {
		wmprintf("Failed to allocate audio buffer\r\n");
		return;
	}
#endif
