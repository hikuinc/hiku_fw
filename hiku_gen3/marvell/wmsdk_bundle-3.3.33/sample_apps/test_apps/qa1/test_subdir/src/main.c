 ...
 */
/*
 * Test recursive subdir Application
 *
 * Summary:
 *
 * Prints Hello subdir every 5 seconds on the serial console.
...
int main(void)
{
	...
	wmprintf("Hello subdir application Started\r\n");

	while (1) {
		count++;
		wmprintf("Hello subdir: iteration %d\r\n", count);
