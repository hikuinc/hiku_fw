...
struct cloud {
	...
	void (*app_cloud_handle_req) (struct json_str *jstr, jobj_t *obj,
				      bool *repeat_POST);
};
...
#define CLOUD_ENABLED          "cloud.enabled"
...
int cloud_tls_cert_load(void);
void cloud_tls_cert_unload(void);
#endif
