 ...
 * of i2c-slave device.
 * Connect wakeup pin(I40) of i2c-master to WAKEUP0 of i2c-slave
 */
 ...
 * bytes data as response to the command. The response depends on the command
...
/* This function starts communication over I2C bus */
