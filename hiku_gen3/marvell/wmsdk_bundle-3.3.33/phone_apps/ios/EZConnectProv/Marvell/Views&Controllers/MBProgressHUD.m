...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self)
    {
        ...
        //self = (MBProgressHUD*)self.progressView;
        /*
        ...
        self.opacity = 0.8f;
        self.labelFont = [UIFont fontWithName:@"HelveticaNeue" size:LABELFONTSIZE];//[UIFont boldSystemFontOfSize:LABELFONTSIZE]
        ...
        // Add label
        label = [[UILabel alloc] initWithFrame:CGRectMake(0, 40,250,40 )];
...
- (void)layoutSubviews {
    ...
    // CGRect frame =
    //imgView.frame =
//    imgView = [[UIImageView alloc]initWithFrame:indicator.frame];
//    imgView.image = [UIImage imageNamed:@"popup_bg.png"];
    //imgView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"popup_bg.png"]];
    //[imgView setBounds:indicator.bounds];
