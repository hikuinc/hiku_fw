...
{
	app_ctrl_data_t *p2p_data = os_mem_alloc(sizeof(app_ctrl_data_t));
	...
	case P2P_AUTO_GO_STARTED:
		...
		p2p_data->app_data.p2p_role_data.role = ROLE_AUTO_GO;
		p2p_data->app_data.p2p_role_data.data = data;
		app_ctrl_notify_event(AF_EVT_P2P_STARTED, p2p_data);
		break;
	case P2P_DEVICE_STARTED:
		p2p_data->app_data.p2p_role_data.role = ROLE_UNDECIDED;
		p2p_data->app_data.p2p_role_data.data = data;
		app_ctrl_notify_event(AF_EVT_P2P_STARTED, p2p_data);
	...
	case P2P_CLIENT_STARTED:
		...
		p2p_data->app_data.p2p_role_data.role = ROLE_CLIENT;
		p2p_data->app_data.p2p_role_data.data = data;
	...
	case P2P_GO_STARTED:
		...
		p2p_data->app_data.p2p_role_data.role = ROLE_GO;
		p2p_data->app_data.p2p_role_data.data = data;
		app_ctrl_notify_event(AF_EVT_P2P_ROLE_NEGOTIATED,
				p2p_data);
		break;
