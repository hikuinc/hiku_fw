...
error_type_t usb_hiddevice_init(void)
{
    ...
    uint8_t USB_HID_DESCRIPTOR[] = {
	/* size of this descriptor in bytes */
	(uint8_t) sizeof(HID_DESCRIPTOR),
	/* HID descriptor type */
	HID_DESCRIPTOR_TYPE,
	/* USB HID specification release version */
	WBVAL(HID_V1_10),
	...
	/* Total length of Report decriptor*/
	WBVAL((uint16_t) sizeof(ReportDescriptor))
    };
    ...
    usbInterface0.ClassDesc = USB_HID_DESCRIPTOR;
