...
{                                                              \
       ...
       if(cancelTaskTCB->xGenericListItem.pvContainer){        \
               ...
               uxListRemove( &( cancelTaskTCB->xGenericListItem ) );    \
                                                               \
	...
	UBaseType_t uxTask = 0;
		...
		if( listCURRENT_LIST_LENGTH( pxList ) > ( UBaseType_t ) 0 )
		{
			...
			do
			{
				...
				pxTaskStatusArray[ uxTask ].pxTopOfStack = (uint32_t) pxNextTCB->pxTopOfStack;
				pxTaskStatusArray[ uxTask ].pxStack = (uint32_t) pxNextTCB->pxStack;
