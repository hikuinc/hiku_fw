...
#define ACA_VERSION_REVISION    2   ///< Incremented on bug fix.
...
#define ARRAYENT_MIN_STACK_SIZE                 5000 ///< Minimum stack size of AICD thread
 ...
 *
 * Note that your application must still set most fields in the ACA configuration structure
 * after having called this function on it. This function only populates settings for optional
 * features of ACA.
 *
