...
t_bh_generator := $(d)src/$(arch_name-y)/bh_generator$(file_ext)
...
$(t_bh_generator): $(bh_generator-objs-y)
	$(AT) gcc $(bh_generator-cflags-y) $(bh_generator-lflags-y) $(bh_generator-objs-y) -o $@
	@echo " [cc] $(bh_generator-objs-y)"

$(t_bh_generator).clean:
	$(AT) $(t_rm) -f $(t_bh_generator)

boot2.clean: $(t_bh_generator).clean
