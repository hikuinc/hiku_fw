 ...
 * encryption/decryption functions are aligned to M_AES_BLOCK_SIZE
 *
 * Typical example:
 *
 * Encryption:
 ...
 *            &initial_vector, M_AES_ENCRYPTION, HW_AES_MODE_CBC);
 *
...
typedef struct {
	...
	bool data_buffered;
	uint8_t buffered_data[M_AES_BLOCK_SIZE];
	uint8_t bufferCnt;
	uint8_t buf_idx;
 ...
 * \param[in] dir Is either M_AES_ENCRYPTION or M_AES_DECRYPTION
