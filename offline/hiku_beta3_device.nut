...
hardware.pinE.configure(DIGITAL_OUT, 1);
...
gAudioBuffer <- [blob(gAudioBufferSize), blob(gAudioBufferSize), blob(gAudioBufferSize), blob(gAudioBufferSize), blob(gAudioBufferSize)];
